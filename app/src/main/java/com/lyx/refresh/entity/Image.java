...
public class Image {
    ...
    public static List<Image> getImageList() {
        ...
        list.add(new Image(new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date(System.currentTimeMillis())), "http://img5.imgtn.bdimg.com/it/u=3309309276,772089047&fm=11&gp=0.jpg"));
        ...
        list.add(new Image(new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date(System.currentTimeMillis())), "http://img4.imgtn.bdimg.com/it/u=3737919190,3601406056&fm=27&gp=0.jpg"));
        list.add(new Image(new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date(System.currentTimeMillis())), "http://img5.imgtn.bdimg.com/it/u=4135556321,3079210894&fm=27&gp=0.jpg"));
        ...
        list.add(new Image(new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date(System.currentTimeMillis())), "http://img2.imgtn.bdimg.com/it/u=576945198,1322704226&fm=11&gp=0.jpg"));
        ...
        list.add(new Image(new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date(System.currentTimeMillis())), "http://img3.imgtn.bdimg.com/it/u=569927511,3767989042&fm=11&gp=0.jpg"));
